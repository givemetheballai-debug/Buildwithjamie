  ...
  return (
    <>
      ...
      <div style={{
        ...
        <h1 style={{fontSize: '3rem', marginBottom: '1rem'}}>Intro to AI</h1>
      ...
      <section style={{padding: '4rem 2rem', background: '#f8f9fa'}}>
        <div style={{maxWidth: '900px', margin: '0 auto'}}>
          ...
          <div style={{background: 'white', padding: '2.5rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', marginBottom: '2rem'}}>
            <h2 style={{color: '#2c3e50', marginBottom: '1rem', fontSize: '1.8rem', borderBottom: '3px solid #667eea', paddingBottom: '0.5rem'}}>What is AI?</h2>
          ...
          {/* Popular AI Tools */}
          <div style={{background: 'white', padding: '2.5rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', marginBottom: '2rem'}}>
            <h2 style={{color: '#2c3e50', marginBottom: '1rem', fontSize: '1.8rem', borderBottom: '3px solid #667eea', paddingBottom: '0.5rem'}}>Popular AI Tools</h2>
          ...
          <div style={{background: 'white', padding: '2.5rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', marginBottom: '2rem'}}>
            <h2 style={{color: '#2c3e50', marginBottom: '1rem', fontSize: '1.8rem', borderBottom: '3px solid #667eea', paddingBottom: '0.5rem'}}>How to Write Good Prompts</h2>
          ...
          {/* Tokens & Memory */}
          <div style={{background: 'white', padding: '2.5rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', marginBottom: '2rem'}}>
            <h2 style={{color: '#2c3e50', marginBottom: '1rem', fontSize: '1.8rem', borderBottom: '3px solid #667eea', paddingBottom: '0.5rem'}}>Tokens & Memory</h2>
          ...
          {/* RAG */}
          <div style={{background: 'white', padding: '2.5rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', marginBottom: '2rem'}}>
            <h2 style={{color: '#2c3e50', marginBottom: '1rem', fontSize: '1.8rem', borderBottom: '3px solid #667eea', paddingBottom: '0.5rem'}}>RAG: Retrieval-Augmented Generation</h2>
          ...
          {/* What Actually Works */}
          <div style={{background: 'white', padding: '2.5rem', borderRadius: '8px', boxShadow: '0 2px 8px rgba(0,0,0,0.1)', marginBottom: '2rem'}}>
            <h2 style={{color: '#2c3e50', marginBottom: '1rem', fontSize: '1.8rem', borderBottom: '3px solid #667eea', paddingBottom: '0.5rem'}}>What Actually Works: Lessons from Heavy Use</h2>
