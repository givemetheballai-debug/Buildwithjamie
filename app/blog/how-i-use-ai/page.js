        ...
        <div className="article-wrapper">
          ...
          <section>
            ...
            <div className="prompt-box">
              <p className="prompt-label">Example prompt:</p>
          ...
          <section>
            ...
            <div className="prompt-box">
              <p className="prompt-label">Or for interview prep:</p>
              <p className="prompt-text">
          ...
          <section>
            ...
            <div className="prompt-box">
              <p className="prompt-label">Or for naming:</p>
              <p className="prompt-text">
